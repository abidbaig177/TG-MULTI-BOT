...
async def start_message(bot, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton("🍁 ꜱᴜᴩᴩᴏʀᴛ", url="https://t.me/Cyber_Robots"),
        InlineKeyboardButton("📯 ᴜᴩᴅᴀᴛᴇꜱ", url="https://t.me/Cyber_Robots_Support")
        ],[            
...
async def media_info(bot, m): 
    ...
    if not md:
        buttons = [[
            InlineKeyboardButton("✨️ Support", url="https://t.me/Cyber_Robots"),
            InlineKeyboardButton("📢 Updates", url="https://t.me/Cyber_Movies")
        ]]       
